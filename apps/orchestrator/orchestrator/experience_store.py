...
class ExperienceEnhancedGenerateService:
    ...
    async def generate_changes(self, task, plan):
        ...
        3. 없으면 LLM으로 생성
        """
        from apps.orchestrator.orchestrator.domain.models import ChangeType, CodeChange
        ...
        from apps.orchestrator.orchestrator.domain.real_services import RealGenerateService

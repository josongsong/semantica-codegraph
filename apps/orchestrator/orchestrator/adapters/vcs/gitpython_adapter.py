...
from apps.orchestrator.orchestrator.domain.models import CodeChange
from codegraph_shared.ports import IVCSApplier
    ...
    def _get_repo(self):
        ...
        if self._repo is None:
            try:
                ...
                raise ImportError("gitpython not installed. Run: pip install gitpython") from e

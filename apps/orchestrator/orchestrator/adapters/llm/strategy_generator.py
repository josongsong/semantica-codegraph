...
from apps.orchestrator.orchestrator.shared.reasoning.tot.tot_models import CodeStrategy, StrategyType
...
class StrategyGeneratorLLM:
    ...
    def __init__(
        ...
        """
        # SOTA: 안전한 환경변수 로딩
        from apps.orchestrator.orchestrator.adapters.llm.env_loader import SafeEnvLoader

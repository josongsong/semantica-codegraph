...
if TYPE_CHECKING:
    from apps.orchestrator.orchestrator.domain.real_services import (
        RealAnalyzeService as AnalyzeService,
    )
    from apps.orchestrator.orchestrator.domain.real_services import (
        RealCriticService as CriticService,
    )
    from apps.orchestrator.orchestrator.domain.real_services import (
        RealGenerateService as GenerateService,
    )
    from apps.orchestrator.orchestrator.domain.real_services import (
        RealHealService as HealService,
    )
    from apps.orchestrator.orchestrator.domain.real_services import (
        RealPlanService as PlanService,
    )
    from apps.orchestrator.orchestrator.domain.real_services import (
        RealTestService as TestService,
    )

...
class AgentExperience:
    ...
    # Identity
    id: int | None = None
    session_id: str | None = None  # Session tracking (Phase 6)
...
class ExperienceQuery:
    ...
    # Session-based search (Phase 6)
    session_id: str | None = None
    session_history: list[str] = field(default_factory=list)  # Recent requests in session

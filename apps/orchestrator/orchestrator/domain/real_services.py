...
Your JSON response:""",
        ...
        try:
            ...
            from apps.orchestrator.orchestrator.dto.llm_dto import AnalysisOutputDTO
...
3. Risk assessment""",
        ...
        try:
            from apps.orchestrator.orchestrator.dto.llm_dto import PlanOutputDTO
...
Your JSON response:""",
        ...
        try:
            from apps.orchestrator.orchestrator.dto.llm_dto import CodeChangesOutputDTO
...
If everything looks good, approve. If critical issues exist, reject with brief explanations.""",
        ...
        try:
            from apps.orchestrator.orchestrator.dto.llm_dto import CritiqueOutputDTO

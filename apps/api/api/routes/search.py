...
Provides unified search endpoints using the Index Layer.

Architecture:
    FastAPI → IndexingService → (Zoekt + Qdrant + Graph) → SearchHit
...
Endpoints:
    ...
    GET /search/symbol       - Symbol search only (Graph)
"""
...
from codegraph_engine.multi_index.infrastructure import (
    IndexingService,

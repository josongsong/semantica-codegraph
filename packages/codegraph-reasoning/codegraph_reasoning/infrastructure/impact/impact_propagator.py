...
from codegraph_engine.code_foundation.infrastructure.ir.models import EdgeKind, IRDocument
from codegraph_reasoning.domain.models import HashBasedImpactLevel, ImpactType
...
class GraphBasedImpactPropagator:
    ...
    def propagate(self, changed_symbols: set[str], impact_types: dict[str, ImpactType], max_depth: int = 5) -> set[str]:
        ...
        while queue:
            ...
            if impact.level == HashBasedImpactLevel.STRUCTURAL_CHANGE:

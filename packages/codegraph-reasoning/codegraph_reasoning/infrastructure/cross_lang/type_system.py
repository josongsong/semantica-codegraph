...
class TypeCompatibilityChecker:
    ...
    def check_boundary(
        ...
        for req_field, _ in request_schema.items():
            if server_signature and req_field not in server_signature:
                issues.append({"field": req_field, "issue": "missing_in_server", "severity": "error"})

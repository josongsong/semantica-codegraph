...
class DomainAwareContextBuilder:
    ...
    def _get_layer_priority(self, layer: ArchitecturalLayer, query_type: str) -> int:
        """
    ...
    def _adjust_score(self, original_score: float, priority: int, boost_factor: float) -> float:
        """
    ...
    def _get_layer_distribution(self, chunks: list[LayeredChunk]) -> dict[str, int]:
        """

...
from codegraph_search.infrastructure.feedback.hard_negatives import (
    HardNegativeMiner,
    RetrainingTrigger,
    TrainingSample,
)
...
if TYPE_CHECKING:
    from codegraph_search.infrastructure.feedback.contrastive_training import (
...
def __getattr__(name: str):
    ...
    if name == "EmbeddingModel":
        from codegraph_search.infrastructure.feedback.contrastive_training import EmbeddingModel

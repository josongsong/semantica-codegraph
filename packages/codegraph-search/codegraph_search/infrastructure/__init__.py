...
Usage:
    from codegraph_search.infrastructure import (
...
from codegraph_search.infrastructure.factory import (
    OptimizationLevel,
    RetrieverConfig,
    RetrieverFactory,
    RetrieverProtocol,
...
from codegraph_search.infrastructure.di import (
    create_retriever_service_minimal,
)

...
if TYPE_CHECKING:
    ...
    from codegraph_search.infrastructure.multi_index.orchestrator import (
...
def __getattr__(name: str):
    ...
    if name == "MultiIndexOrchestrator":
        from codegraph_search.infrastructure.multi_index.orchestrator import MultiIndexOrchestrator

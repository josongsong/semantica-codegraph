...
from codegraph_engine.shared_kernel.contracts.levels import ComplexityLevel
from codegraph_engine.shared_kernel.contracts.thresholds import COMPLEXITY
...
class QueryComplexity:
    ...
    def complexity_level(self) -> ComplexityLevel:
        ...
        if self.specificity_score > COMPLEXITY.HIGH_SPECIFICITY and self.token_count <= COMPLEXITY.SIMPLE_TOKEN_COUNT:
            return ComplexityLevel.SIMPLE
        elif self.specificity_score < COMPLEXITY.LOW_SPECIFICITY or self.token_count > COMPLEXITY.COMPLEX_TOKEN_COUNT:

...
- Role detection for pattern-based role inference
"""
...
from codegraph_engine.code_foundation.infrastructure.generators.python import (
    PythonCallAnalyzer,
...
from codegraph_engine.code_foundation.infrastructure.generators.python.analyzers import (
    ClassAnalyzer,
    FunctionAnalyzer,
    ImportAnalyzer,
    ModuleAnalyzer,
...
from codegraph_engine.code_foundation.infrastructure.generators.python.dataflow_analyzer import DataflowAnalyzer
from codegraph_engine.code_foundation.infrastructure.generators.python.exception_analyzer import ExceptionAnalyzer
from codegraph_engine.code_foundation.infrastructure.generators.python.override_analyzer import analyze_method_overrides
...
class _PythonIRGenerator(IRGenerator):
    """
    ...
    def __init__(
        ...
        Args:
            ...
            enable_role_detection: Enable pattern-based role detection (default: True)
        """
        ...
        # Role detection
        self._role_detector = PythonRoleDetector() if enable_role_detection else None
        ...
        for node in self._nodes:
            ...
            if node.kind.value in ["Class", "Function", "Method"]:
                try:
                    ...
                    logger.warning(
                        "unified_symbol_creation_failed",
                        node_name=node.name,
                        error=str(e),
    ...
    def _add_contains_edge(self, parent_id: str, child_id: str, span: Span):
        ...
        edge_id = generate_edge_id_v2("CONTAINS", parent_id, child_id, 0)
    ...
    def _create_unified_symbol(self, node: Node, source: SourceFile) -> UnifiedSymbol:
        ...
        if type_params:
            _generic_params = type_params if isinstance(type_params, list) else [type_params]

...
if TYPE_CHECKING:
    from codegraph_engine.code_foundation.infrastructure.ir.models import Edge, IRDocument, Node
...
def analyze_method_overrides(ir_doc: IRDocument) -> list[Edge]:
    ...
    """
    from codegraph_engine.code_foundation.infrastructure.ir.models import Edge, EdgeKind, NodeKind

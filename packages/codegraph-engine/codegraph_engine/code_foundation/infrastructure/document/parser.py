...
class DocumentParserRegistry:
    ...
    def __init__(self, profile: DocIndexProfile = DocIndexProfile.BASIC):
        ...
        try:
            from codegraph_engine.code_foundation.infrastructure.document.parsers.notebook_parser import NotebookParser
        ...
        try:
            from codegraph_engine.code_foundation.infrastructure.document.parsers.pdf_parser import PDFParser

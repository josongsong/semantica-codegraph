...
class CFGBlockKind(str, Enum):
    ...
    SUSPEND = "Suspend"  # await suspend point
    RESUME = "Resume"  # await resume point

    # Generator/Coroutine support (Added 2025-12-09 - Phase 2)
    DISPATCHER = "Dispatcher"  # Generator state router

...
from codegraph_engine.code_foundation.infrastructure.symbol_graph.models import RelationKind, SymbolKind
...
class QueryIndexes:
    ...
    Tantivy (lexical), Qdrant (vector), PostgreSQL (fuzzy/domain).
...
class SearchIndex:
    ...
    def search_by_name(self, query: str, limit: int = 10) -> list[SearchableSymbol]:
        ...
        For fuzzy search, use adapters (Tantivy/PostgreSQL).
        """
        results = []

...
class SemanticRegion:
    ...
    primary_symbol: str | None = None  # Main symbol (e.g., function name)
    ...
    def __post_init__(self):
        ...
        if self.start_line > self.end_line:
            raise ValueError("Invalid region: start_line > end_line")
...
class RegionCollection:
    ...
    def get_statistics(self) -> dict[str, Any]:
        ...
        avg_complexity = sum(r.complexity for r in self.regions) / len(self.regions) if self.regions else 0

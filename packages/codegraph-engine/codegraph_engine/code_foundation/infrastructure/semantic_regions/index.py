...
from .models import RegionCollection, RegionPurpose, RegionType, SemanticRegion
...
class SearchResult:
    ...
    def __repr__(self) -> str:
        return (
            f"SearchResult(region={self.region.region_id}, score={self.score:.2f}, reasons={len(self.match_reasons)})"
        )
...
class RegionIndex:
    ...
    def _find_candidates(
        ...
        if not candidates:
            candidates = {r.region_id for r in self.collection.regions}

...
class Layer(str, Enum):
    ...
    L5 = "l5"  # 완전한 Semantic IR (CFG/DFG/BFG, Advanced analysis)


# IndexingMode는 AnalysisMode의 alias (RFC-021: 중복 ENUM 제거)
# 기존 코드 호환성 유지
IndexingMode = AnalysisMode
...
MODE_LAYER_CONFIG: dict[IndexingMode, list[Layer]] = {
    ...
    IndexingMode.DEEP: [Layer.L0, Layer.L1, Layer.L2, Layer.L3, Layer.L4, Layer.L5],

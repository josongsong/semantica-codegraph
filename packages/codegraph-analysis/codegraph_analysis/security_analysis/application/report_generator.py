...
class SecurityReportGenerator:
    ...
    def _get_severity_emoji(self, severity: Severity) -> str:
        """Get emoji for severity (delegates to Severity class)"""
        # Use the Severity class method to avoid duplication
        # Creating a dummy vulnerability just to get emoji is inefficient,
        # so we duplicate the mapping here but reference the authoritative source
        return severity.get_emoji()

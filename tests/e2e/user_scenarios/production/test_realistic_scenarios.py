...
from codegraph_engine.reasoning_engine.infrastructure.pdg.pdg_builder import (
    DependencyType,
    PDGBuilder,
    PDGEdge,
    PDGNode,
)
from codegraph_engine.reasoning_engine.infrastructure.slicer.budget_manager import BudgetConfig, BudgetManager

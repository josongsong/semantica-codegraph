...
from codegraph_engine.reasoning_engine.domain.speculative_models import Delta, DeltaOperation
from codegraph_engine.reasoning_engine.infrastructure.speculative.delta_graph import DeltaGraph

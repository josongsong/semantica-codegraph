...
from .value_tracker import ArgumentValueTracker, TrackedValue
...
class ContextSensitiveAnalyzer:
    ...
    precise_cg_builder: Optional[PreciseCallGraphBuilder] = None
    ...
    def compare_contexts(
        ...
        return {
            ...
            "precision_gain_pct": (
                len(reachable1 - reachable2) / len(reachable1 | reachable2) * 100
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "cs_call_graph": {
                ...
                "avg_contexts_per_edge": (
                    len(self.cs_call_graph) / len(basic_edges) if basic_edges else 0
                ),
            },
        }
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"ContextSensitiveAnalyzer("
            f"{cs_stats['num_edge_types']} edge types, "
            f"{cs_stats['total_contexts']} contexts)"
        )

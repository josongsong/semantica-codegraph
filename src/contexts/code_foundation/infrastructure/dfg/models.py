...
class VariableEntity:
    ...
    Performance Note:
        Uses __slots__ for 30-40% memory reduction and faster attribute access
    """
    ...
    # Additional type fields for inferred types (added for type tracking)
    inferred_type: str | None = None
    inferred_type_id: str | None = None
    type_source: str = "unknown"

    # Scope information (HIGH #10: Variable scope tracking)
    scope_id: str | None = None  # Explicit scope identifier (typically same as function_fqn)
    scope_kind: Literal["module", "function", "method", "lambda", "comprehension", "class"] | None = None
    scope_depth: int = 0  # Nesting level: 0=module, 1=function, 2=nested, etc.
...
class VariableEvent:
    ...
    Performance Note:
        Uses __slots__ for 30-40% memory reduction and faster object creation
    """
...
class DataFlowEdge:
    ...
    Performance Note:
        Uses __slots__ for 30-40% memory reduction and faster edge creation
    """
...
class DfgSnapshot:
    ...
    Performance Note:
        Uses __slots__ for consistent performance across all DFG models
    """

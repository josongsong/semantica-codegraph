...
from src.contexts.code_foundation.infrastructure.document.chunker import DocumentChunk
...
class DocumentIndexAdapter:
    ...
    def to_index_document(self, doc_chunk: DocumentChunk) -> IndexDocument:
        """
        ...
        Returns:
            IndexDocument for vector/domain indexing
        """
        # Generate chunk ID

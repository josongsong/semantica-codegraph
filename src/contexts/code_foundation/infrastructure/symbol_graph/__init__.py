...
from src.contexts.code_foundation.infrastructure.symbol_graph.models import (
    Relation,
    RelationIndex,
    RelationKind,
    Symbol,
...
from src.contexts.code_foundation.infrastructure.symbol_graph.port import SymbolGraphPort

if TYPE_CHECKING:
    from src.contexts.code_foundation.infrastructure.symbol_graph.builder import SymbolGraphBuilder
    from src.contexts.code_foundation.infrastructure.symbol_graph.postgres_adapter import PostgreSQLSymbolGraphAdapter
...
def __getattr__(name: str):
    ...
    if name == "PostgreSQLSymbolGraphAdapter":
        from src.contexts.code_foundation.infrastructure.symbol_graph.postgres_adapter import (

...
from src.contexts.code_foundation.infrastructure.ir.models import IRDocument, NodeKind
...
if TYPE_CHECKING:
    ...
    from src.contexts.code_foundation.infrastructure.semantic_ir.cfg.models import ControlFlowBlock as CFGBlock
...
class GraphBuilder:
    ...
    def _convert_ir_edges(self, ir_doc: IRDocument, graph: GraphDocument):
        ...
        """
        from src.contexts.code_foundation.infrastructure.graph.models import GraphEdge
    ...
    def _generate_type_reference_edges(self, ir_doc: IRDocument, graph: GraphDocument):
        ...
        """
        from src.contexts.code_foundation.infrastructure.graph.models import GraphEdge, GraphEdgeKind
    ...
    def _build_indexes(self, graph: GraphDocument):
        ...
        from src.contexts.code_foundation.infrastructure.graph.models import GraphEdgeKind
    ...
    def _map_cfg_edge_to_graph_edge(self, cfg_edge_kind) -> "GraphEdgeKind":
        ...
        """
        from src.contexts.code_foundation.infrastructure.graph.models import GraphEdgeKind
        from src.contexts.code_foundation.infrastructure.semantic_ir.cfg.models import CFGEdgeKind

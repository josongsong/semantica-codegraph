...
from src.contexts.code_foundation.infrastructure.semantic_ir.context import TypeIndex
...
class TypeIrBuilder:
    ...
    def _enhance_types_with_resolver(self, types: list[TypeEntity], ir_doc: IRDocument):
        ...
        """
        from src.contexts.code_foundation.infrastructure.semantic_ir.typing.models import TypeResolutionLevel

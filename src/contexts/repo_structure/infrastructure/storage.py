...
Implementations:
- InMemoryRepoMapStore: For testing and development (volatile)
- JsonFileRepoMapStore: Recommended for production (persistent + in-memory cache)
- PostgresRepoMapStore: [DEPRECATED] Use JsonFileRepoMapStore instead (in storage_postgres.py)
"""
...
# ============================================================================
# Additional Implementations (imported for convenience)
# ============================================================================

# JsonFileRepoMapStore: Recommended for production
...
try:
    ...
    class JsonFileRepoMapStore:
        """
        Stub class when JsonFileRepoMapStore is not available.
        """

        def __init__(self, *args, **kwargs):
            raise ImportError("JsonFileRepoMapStore is not implemented yet.")


# PostgresRepoMapStore: [DEPRECATED] in storage_postgres.py
# Import here for backwards compatibility, but shows deprecation warning on use
try:
    from src.contexts.repo_structure.infrastructure.storage_postgres import PostgresRepoMapStore
except ImportError:
    # asyncpg not installed, define stub
    class PostgresRepoMapStore:
        """
        [DEPRECATED] Stub class when asyncpg is not available.

        Use JsonFileRepoMapStore instead for simpler deployment.
        """

        def __init__(self, connection_string: str):
            raise ImportError(
                "asyncpg is required for PostgresRepoMapStore. "
                "Install with: pip install asyncpg\n"
                "NOTE: PostgresRepoMapStore is deprecated. "
                "Use JsonFileRepoMapStore instead for simpler deployment."
            )

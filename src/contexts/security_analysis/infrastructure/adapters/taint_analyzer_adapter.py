...
class TaintAnalyzerAdapter:
    ...
    def analyze(self, ir_document: IRDocument) -> list[TaintPath]:
        ...
        try:
            ...
            print(f"[ADAPTER ANALYZE] Found {len(source_nodes)} sources, {len(sink_nodes)} sinks")
            ...
            if not taint_paths and source_nodes and sink_nodes:
                ...
                for source_id in source_nodes:
                    print(f"[ADAPTER ANALYZE] Processing source: {source_id}")
                    for sink_id in sink_nodes:
                        print(f"[ADAPTER ANALYZE] Processing sink: {sink_id}")

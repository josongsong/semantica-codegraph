...
class AutoRRF:
    ...
    def search(
        ...
        results = self._compute_rrf_scores(graph_results, embedding_results, symbol_results, weights)
    ...
    def add_feedback(
        ...
        logger.info(
            "feedback_recorded", intent=intent.value, rank=clicked.rank, num_feedback=len(self._feedback_history)
        )
    ...
    def _update_weights(self):
        ...
        for intent, feedbacks in by_intent.items():
            ...
            logger.info(
                ...
                intent=intent.value,
                new_weights={
                    "graph": adjusted.graph_weight,
                    "embedding": adjusted.embedding_weight,
                    "symbol": adjusted.symbol_weight,
                },
            )

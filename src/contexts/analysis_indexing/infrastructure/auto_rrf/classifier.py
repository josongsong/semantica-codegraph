    ...
    def __post_init__(self):
        ...
        self._profiles = {
            QueryIntent.API_USAGE: WeightProfile(
                ...
                symbol_weight=0.2,  # High: call graph important
            ),
            QueryIntent.EXPLAIN_LOGIC: WeightProfile(
                graph_weight=0.2,
                embedding_weight=0.7,
                symbol_weight=0.1,  # High: semantic understanding
            ),
            ...
            QueryIntent.TRACE_DATAFLOW: WeightProfile(
                graph_weight=0.7,
                embedding_weight=0.2,
                symbol_weight=0.1,  # High: graph traversal
            ),
            QueryIntent.GENERAL: WeightProfile(graph_weight=0.33, embedding_weight=0.34, symbol_weight=0.33),
        }

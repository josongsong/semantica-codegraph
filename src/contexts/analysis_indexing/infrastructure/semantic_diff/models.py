...
class SemanticChange:
    ...
    def __repr__(self) -> str:
        return f"SemanticChange(type={self.change_type.value}, severity={self.severity.name}, symbol={self.symbol_id})"
...
class SemanticDiff:
    ...
    def __repr__(self) -> str:
        ...
        return f"SemanticDiff({stats['total_changes']} changes, {stats['breaking_changes']} breaking)"
...
class DiffContext:
    ...
    old_call_graph: Any | None = None

    # New version
    new_ir: dict[str, Any] = field(default_factory=dict)
    new_call_graph: Any | None = None
    ...
    def get_old_symbol(self, symbol_id: str) -> Any | None:
    ...
    def get_new_symbol(self, symbol_id: str) -> Any | None:
    ...
    def __repr__(self) -> str:
        return f"DiffContext(old_files={len(self.old_ir)}, new_files={len(self.new_ir)})"

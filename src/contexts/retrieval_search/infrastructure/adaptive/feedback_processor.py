...
Usage:
    ...
    # Or programmatically
    from src.contexts.retrieval_search.infrastructure.adaptive.feedback_processor import FeedbackProcessor
...
from src.contexts.retrieval_search.infrastructure.adaptive.weight_learner import AdaptiveWeightLearner, FeedbackSignal

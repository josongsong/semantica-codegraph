...
from src.contexts.retrieval_search.infrastructure.intent.monitor import FallbackStats, IntentFallbackMonitor
from src.contexts.retrieval_search.infrastructure.intent.prompts import (
...
if TYPE_CHECKING:
    from src.contexts.retrieval_search.infrastructure.intent.service import IntentAnalyzer

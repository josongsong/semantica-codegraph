...
from src.contexts.retrieval_search.infrastructure.observability.models import RetrievalTrace
...
class RetrievalTracer:
    ...
    def start_trace(self, query: str, intent: str = "unknown", scope_type: str = "repo") -> RetrievalTrace:
        """
...
class TraceCollector:
    ...
    def get_statistics(self) -> dict[str, any]:
        ...
        avg_stage_latencies = {stage: sum(latencies) / len(latencies) for stage, latencies in stage_stats.items()}
        ...
        return {
            ...
            "avg_stage_latencies": {k: f"{v:.1f}ms" for k, v in avg_stage_latencies.items()},

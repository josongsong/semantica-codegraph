...
from src.contexts.retrieval_search.infrastructure.fusion.weights import get_weights_for_intent
...
class CorrelationAwareFusion:
    ...
    def fuse(
        ...
        from src.contexts.retrieval_search.infrastructure.fusion.normalizer import ScoreNormalizer
        ...
        for chunk_id, source_hits in chunk_hits.items():
            ...
            from src.contexts.retrieval_search.infrastructure.fusion.weights import (

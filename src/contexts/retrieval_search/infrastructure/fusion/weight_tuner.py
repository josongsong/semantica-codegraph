...
from src.contexts.retrieval_search.infrastructure.fusion.weight_validator import WeightValidator

if TYPE_CHECKING:
    from src.contexts.retrieval_search.infrastructure.fusion.golden_set import GoldenSet

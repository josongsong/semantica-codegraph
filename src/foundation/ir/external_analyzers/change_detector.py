...
class ChangeDetector:
    ...
    def detect_all_uncommitted(
        ...
        Returns:
            (changed_files, deleted_files)
        """
        return self.detect_changed_files(
            since_commit=None, file_extensions=file_extensions
        )
    ...
    def detect_since_last_snapshot(
        ...
        """
        return self.detect_changed_files(
            since_commit=snapshot_commit, file_extensions=file_extensions
        )

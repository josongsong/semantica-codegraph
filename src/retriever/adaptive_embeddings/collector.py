...
from .models import AdaptationExample, AdaptationStatus
...
class AdaptationCollector:
    ...
    def log_implicit_negative(
        ...
        negative_chunk_ids = [
            r.get("chunk_id") for r in shown_results[:5] if r.get("chunk_id")
        ]
    ...
    def get_training_examples(
        self, repo_id: str, min_samples: int | None = None

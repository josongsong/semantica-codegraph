...
from src.agent.schemas import GetSpanInput, GetSpanOutput, OpenFileInput, OpenFileOutput
...
class GetSpanTool(BaseTool[GetSpanInput, GetSpanOutput]):
    ...
    description = (
        ...
        "Returns only the requested lines."
    )
        ...
        try:
            ...
            if (
                ...
                return GetSpanOutput(
                    ...
                    start_line=input_data.start_line,
                    end_line=input_data.end_line,
                    error=f"Invalid line range: {input_data.start_line}-{input_data.end_line} (file has {total_lines} lines)",
                )
